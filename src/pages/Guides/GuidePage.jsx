...
const GuidePage = () => {
    ...
    try {
      const loadPageData = async () => {
        const res = await sendRequest({
          url: `${import.meta.env.VITE_BACKEND_DOMAIN}/programs/${program_id}`,
          headers: {
        ...
        setPageContents(res);
        setBackgroundImage(
          `${import.meta.env.VITE_BACKEND_DOMAIN}/images?filePath=guide-pics/${
            res.program_img
          }`
        );
  ...
  const showAlert = () => {
    ...
    setSnackbarMessage(
      "Please save your changes before navigating to another page."
    );
  ...
  const handleCoverPhoto = async (event) => {
    ...
    const res = await axios.post(
      ...
      }/images/update?filePath=guide-pics/${pageContents.program_img}`,
      uploadData,
      {
        headers: {
    ...
    if (res.data.result === true) {
      const res2 = await axios.post(
        `${import.meta.env.VITE_BACKEND_DOMAIN}/programs/change_img`,
        requestData2
      );
  ...
  const handleAddPage = async () => {
    ...
    try {
      const res = await axios.post(
        `${import.meta.env.VITE_BACKEND_DOMAIN}/programs/create_page`,
        uploadData
      );
            ...
            <div className="page-view">
              ...
              <main className="page-body">
                <div className="page-selector">
                  ...
                  <ul>
                    {pageContents?.program_pages &&
                    pageContents.program_pages.length > 0 ? (
                ...
                <div className="page-edit">
                  <div className="page-title-sm">
                    <p>{pageContents.program_heading}</p>
                  </div>
                  <div
