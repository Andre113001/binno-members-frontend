    ...
    <>
      {props.isEditing ? (
        <div className={styles["editingContainer"]}>
          <SnackbarComponent />
          <CustomModal content={currentModal} />
          <section className={styles["form-container"]}>
            <h1 className={styles["editing_header"]}>
              {changeForm ? "Your Profile" : "Change Password"}
            </h1>
            {changeForm ? (
              <Fragment>
                <div className={styles["form-row"]}>
                  <div className={styles["form-col"]}>
                    <label htmlFor="company_name">
                      Company Name
                      <ToolTip1
                        title={`Changing the name will have a one-year duration before changing to another name. ${
                          profileData?.institution_change_valid_date
                            ? `You may change your institution's name by ${moment(
                                profileData.institution_change_valid_date
                              ).format("MMMM D, YYYY")}.`
                            : ""
                        }`}
                      ...
                      InputProps={
                        isEditingField("contactNum")
                          ...
                          : {
                              ...
                              // Render save button only if edit is false
                              endAdornment: (
                                <Button
                                  onClick={() =>
                                    handleToggleEditField("contactNum")
                                  } // Set edit to true when clicked
                                  sx={{
                                    textTransform: "none",
                                    color: "#292d3e",
                                    "&:hover": {
                ...
                <div className={styles["form-row"]}>
                  <div className={styles["form-col"]}>
                    ...
                    >
                      <span style={{ flex: 1 }}>Web Links</span>
                        ...
                        <TextField
                          ...
                          InputProps={
                            toggleLinkEdit
                              ...
                              : {
                                  endAdornment: isEditingField("links") && (
                                    <IconButton
                                      onClick={() =>
                                        handleRemoveLink(link.link_id)
                                      }
                                    >
                                      <Clear sx={{ color: "red" }} />
                                    </IconButton>
