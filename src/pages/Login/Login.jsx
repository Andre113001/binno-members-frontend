                    ...
                    <>
                        ...
                        <Box component="form" onSubmit={handleSubmit} noValidate sx={{ mt: 1 }}>
                            <TextField
                                ...
                                helperText={(accessKeyError && "Access Key is required") || (overallError && "Invalid Access Key")}
                                margin="normal"
                                required
                                fullWidth
                                id="access-key"
                            ...
                            <TextField
                                ...
                                helperText={(passwordError && "Password is required") || (overallError && "Invalid Password")}
                                margin="normal"
                                required
                                fullWidth
                                name="password"
                ...
                {currentSection === 2 && (
                    <>
                        <Box sx={{ mt: 1 }}>
                            ...
                            <MuiOtpInput TextFieldsProps={{ placeholder: '#', error: overallError, disabled: otpCompleted }} style={{ marginTop: 20 }} onComplete={handleOtpComplete} length={6} value={otp} onChange={handleOtpChange} validateChar={validateChar} />
                            {overallError && (
                                <>
                                    <Typography variant="body2" align="center" color="error" margin={3}>
                                        Invalid OTP
                                    </Typography>
                                    <Typography variant="body2" align="center" color="error" margin={3}>
